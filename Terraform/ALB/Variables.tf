...
variable "log_bucket_name" {
  ...
  default     = "matabit-terraform-state-bucket"
}
...
variable "subnets" {
  ...
  type        = "list"
  default     = ['subnet-0227801dc0e6c460a','subnet-0227801dc0e6c460a','subnet-0227801dc0e6c460a']
}
...
variable "security_groups" {
  ...
  type        = "list"
  default     = ['sg-041946ace3aa221e9','sg-04ea42c6e57a6758a','sg-07ad197331f79dda5','sg-0a97ddd9a5cf26b31']
}
